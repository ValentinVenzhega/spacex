				...
				<table className="table">
					...
					<thead>
						<tr>
							...
							<td className="table-column">{height.meters} m / {height.feed} ft</td>
						</tr>
						<tr>
							<td className="table-column">DIAMETER</td>
							<td className="table-column">{diameter.meters} m / {diameter.feed} ft</td>
						</tr>
						<tr>
							<td className="table-column">MASS</td>
							<td className="table-column">3{mass.kg} kg /{mass.lb} lb</td>
						</tr>
